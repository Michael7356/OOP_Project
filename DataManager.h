...
public:
    static void checkInitFile(const std::string& filename);
    ...
    static void loadCategory(const std::string& filepath);

    static void saveCategory(const std::string& filepath);
